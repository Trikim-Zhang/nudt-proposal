\section{开题报告评议小组意见及评议结果}\label{sec:groupComments}
...
{
	\noindent
\begin{tabular*}{0.999\textwidth}{|p{0.05\textwidth}<{\centering}|p{0.09\textwidth}<{\centering}|p{0.08\textwidth}<{\centering}|p{0.454\textwidth}<{\centering}|p{0.18\textwidth}<{\centering}|}
%	\hline 
